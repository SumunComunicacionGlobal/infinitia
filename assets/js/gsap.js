document.addEventListener('DOMContentLoaded', function () {
  ...
  gsap.utils.toArray('.site-main .wp-block-cover__inner-container > * > *, .site-main .is-layout-flow > * > *:not(strong), .wp-block-separator, .single .entry-content > .wp-block-image, .colophon .wp-block-column').forEach(function (element) {
    gsap.from(element, {
      scrollTrigger: {
        trigger: element,
        start: 'top 80%',
