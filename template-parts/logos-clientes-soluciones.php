...
$render_logo_marquee_items = static function () use ( $clientes_query ) {
	while ( $clientes_query->have_posts() ) :
		...
		?>
		<figure class="smn-clientes-logos__item cliente-<?php the_ID(); ?>">
...
<div class="smn-clientes-shortcode">
	<div class="infinite-scroll is-faded is-slower is-layout-flex is-nowrap">
		<?php if ( $clientes_query->have_posts() ) : ?>
			<div class="wp-block-group is-nowrap is-layout-flex">
				<?php $render_logo_marquee_items(); ?>
			</div>
			<?php $clientes_query->rewind_posts(); ?>
			<div class="wp-block-group is-nowrap is-layout-flex" aria-hidden="true">
				<?php $render_logo_marquee_items(); ?>
			</div>
